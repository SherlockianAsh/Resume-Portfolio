    ...
    <div className="card-page">
      <div className="card-container">
        <div className="card-body">
          ...
          {/* Contact Links */}
          <Reveal staggerSelector="[data-reveal-item]" className="card-links">
            <a href={`tel:${profile.phone}`} className="card-link" data-reveal-item>
            ...
            <a href={`mailto:${profile.email}`} className="card-link" data-reveal-item>
              <div className="card-link-icon">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <a href={profile.linkedinUrl} target="_blank" rel="noopener noreferrer" className="card-link" data-reveal-item>
              <div className="card-link-icon">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <a href={profile.githubUrl} target="_blank" rel="noopener noreferrer" className="card-link" data-reveal-item>
              <div className="card-link-icon">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="card-link" data-reveal-item style={{ cursor: "default" }}>
              <div className="card-link-icon">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
